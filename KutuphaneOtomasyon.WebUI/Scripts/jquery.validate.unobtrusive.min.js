...
//$.validator.unobtrusive.adapters.addSingleVal("unsafe", "chars");
//$.validator.addMethod("unsafe", function (value, element, exclude) {
//    if (value) {
...
//    return true;
//});
//$.validator.unobtrusive.adapters.addSingleVal("space", "chars");
//$.validator.addMethod("space", function (value, element, exclude) {
//    if (value) {
//        for (var i = 0; i < exclude.length; i++) {
//            if (jQuery.inArray(exclude[i], value) != -1) {
//                return false;
